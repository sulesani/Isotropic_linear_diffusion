...
int main() {
    ...
    Data data_array[5];
    data_array[0].set_data("office_noisy.png", 1, "Question_1_t=1_d=1", 50);
    data_array[1].set_data("office_noisy.png", 5, "Question_1_t=5_d=1", 10);
    data_array[2].set_data("office_noisy.png", 10, "Question_1_t=10_d=1", 10);
    ...
    for (int i = 0; i < sizeof(data_array); i++) {
        ...
        string path_image_folder = "images/";
